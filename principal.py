...
def sub_tela(d,conf):
    ...
    if d == 3:
        ...
        while running:
            ...
            draw_text('Graduando em Engenharia Mecatrônica',font, (25, 25, 25), screen, 105, 90)
            draw_text('COLABORADORES:', font, (255, 0, 0), screen, 20, 120)
            draw_text('MONITOR 1 DE EXPRESSÃO GRAFICA',font, (25, 25, 25), screen, 20, 160)
            draw_text('Graduando em XXXXXXXXXX', font,(25, 25, 25), screen, 105, 190)
            draw_text('MONITOR 1 DE EXPRESSÃO GRAFICA',font, (25, 25, 25), screen, 20, 220)
            ...
            draw_text('Doutor em Engenharia da Computação',font, (25, 25, 25), screen, 105, 400)
    ...
    if d == 4:
        ...
        while running:
            ...
            draw_text('FASE 2 - INTERMEDIÁRIO',font, (25, 25, 25), screen, 60, 240)
